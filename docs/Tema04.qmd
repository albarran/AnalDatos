...
![](figure/eda-boxplot1.png){width=80% fig-align="center"}
...
- PERO es más informativo la distribución **condicional** de frecuencias relativas <!--de una variable dada la otra-->
...
```{r}
#| echo: false
lm(data = pymes, ingresos ~ factor(rating, ordered = F)) |> summary()
```
...
3. Las categorías tienen comportamiento similar
